...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let personalMainViewControllerStoryboardId = "personalMainViewControllerStoryboardId"
    let createFamilyViewControllerStoryboardId = "createFamilyViewControllerStoryboardId"
    let leaveMessageViewControllerStoryboardId = "leaveMessageViewControllerStoryboardId"
    ...
    func prepareDrawerViewController() -> KGDrawerViewController {
        ...
        drawerViewController.backgroundImage = UIImage(named: "green")
...
//    private func tableViewControllerForStoryboardId(storyboardId: String) -> UITableViewController {
//        let tableViewController: UIViewController = drawerStoryboard().instantiateViewControllerWithIdentifier(storyboardId);
...
//    }
    ...
    func personalMainViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(personalMainViewControllerStoryboardId)
        
        return viewController
    }
    
    func createFamilyViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(createFamilyViewControllerStoryboardId)
        
        return viewController
    }
    
    func leaveMessageViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(leaveMessageViewControllerStoryboardId)
        
        return viewController
    }
    
    func familyListViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(familyListViewControllerStoryboardId)
        
        return viewController
    }
    
    func familyZoneViewController() -> UIViewController {
        let viewController = viewControllerForStoryboardId(familyZoneViewControllerStoryboardId)
        
        return viewController
    }
    
    func scheduleTableViewController() -> UIViewController {
        let scheduleViewController = viewControllerForStoryboardId(scheduleTableViewControllerStoryboardId)
